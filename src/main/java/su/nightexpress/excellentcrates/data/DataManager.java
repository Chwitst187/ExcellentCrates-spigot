...
public class DataManager extends AbstractManager<CratesPlugin> {
    ...
    protected void onLoad() {
        this.runDataTask(this::loadData);
    ...
    private void runDataTask(@NotNull Runnable action) {
        try {
    ...
    public GlobalCrateData getCrateDataOrCreate(@NotNull Crate crate) {
        ...
        this.runDataTask(() -> this.plugin.getDataHandler().insertCrateData(fresh));
        this.crateDataMap.put(fresh.getCrateId(), fresh);
        return fresh;
    }

    public void deleteCrateData(@NotNull Crate crate) {
        this.runDataTask(() -> this.plugin.getDataHandler().deleteCrateData(crate));
    ...
    public RewardData getRewardLimitOrCreate(@NotNull Reward reward, @Nullable Player player) {
        ...
        this.runDataTask(() -> this.plugin.getDataHandler().insertRewardLimit(fresh));
    ...
    public void deleteRewardLimit(@NotNull RewardData limit) {
        this.runDataTask(() -> this.plugin.getDataHandler().deleteRewardLimit(limit));
    ...
    public void deleteRewardLimits(@NotNull Crate crate) {
        ...
        this.runDataTask(() -> this.plugin.getDataHandler().deleteRewardLimits(crate));
    ...
    public void deleteRewardLimits(@NotNull Reward reward) {
        ...
        this.runDataTask(() -> this.plugin.getDataHandler().deleteRewardLimits(reward));
    ...
    public void deleteRewardLimits(@NotNull UUID playerId) {
        ...
        this.runDataTask(() -> this.plugin.getDataHandler().deleteRewardLimits(playerId));
